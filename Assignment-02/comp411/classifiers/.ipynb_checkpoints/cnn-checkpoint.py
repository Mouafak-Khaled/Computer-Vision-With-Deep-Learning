...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        C, H, W = input_dim
        H_p, W_p = (H - 2)//2 + 1, (W - 2)//2 + 1 # after max pooling
        self.params['W1'] = np.random.normal(0.0, weight_scale, (num_filters, C, filter_size, filter_size))
        self.params['b1'] = np.zeros(num_filters)
        self.params['W2'] = np.random.normal(0.0, weight_scale, (num_filters * H_p * W_p, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        A1, cache = conv_lrelu_pool_forward(X, W1, b1, conv_param, lrelu_param, pool_param)
        ...
        dX, dW1, db1 = conv_lrelu_pool_backward(dA1, cache)
